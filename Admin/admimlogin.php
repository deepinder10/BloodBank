...
<tr><td>&nbsp;</td> <td class="lefttd">User Name</td><td>&nbsp;</td> <td><input type="text" name="t1" /></td></tr>
<tr><td>&nbsp;</td> <td class="lefttd">Password</td><td>&nbsp;</td> <td><input type="password"name="t2" /></td></tr>


<tr><td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td><td><input type="submit" value="Log In" name="sbmt" style="border:0px; background:linear-gradient(#900,#D50000); width:100px; height:30px; border-radius:10px 1px 10px 1px; box-shadow:1px 1px 5px black; color:white; font-weight:bold; font-size:14px; text-shadow:1px 1px 6px black; "></td></tr>
